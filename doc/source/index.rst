======================
FirnCorr Documentation
======================

Welcome to the documentation for ``FirnCorr``, a set of Python-based tools for correcting data for surface mass balance and firn processes.
...
.. grid:: 2 2 4 4
    ...
    .. grid-item-card::  Discussions
      :text-align: center
      :link: https://github.com/tsutterley/FirnCorr/discussions

      :material-outlined:`forum;5em`

    .. grid-item-card::  Issues
      :text-align: center
      :link: https://github.com/tsutterley/FirnCorr/issues
